...
library NFTDescriptor {
    ...
    function generateDescriptionPartOne(
        ...
        return
            string(
                abi.encodePacked(
                    'This NFT represents a liquidity position in a OctoSwap CL ',
                    quoteTokenSymbol,
                    '-',
                    baseTokenSymbol,
                    ' pool. ',
    ...
    function generateSVGImage(ConstructTokenURIParams memory params) internal pure returns (string memory svg) {
        NFTSVG.SVGParams memory svgParams =
            NFTSVG.SVGParams({
                ...
                color0: tokenToColorHex(uint256(params.quoteTokenAddress), 130), 
                color1: tokenToColorHex(uint256(params.baseTokenAddress), 130),
                color2: tokenToColorHex(uint256(params.quoteTokenAddress), 6),
                color3: tokenToColorHex(uint256(params.baseTokenAddress), 6),
